 ...
 */
public class Triangle2DY implements Rectangle {
    // bounding box
    ...
    public Triangle2DY(Point2D v1, Point2D v2, Point2D v3) {
        precompute(v1, v2, v3);
    }
    ...
    private static boolean hasNoIntersection(Triangle2DY t1, Triangle2DY t2) {
    ...
    public boolean intersects(Rectangle rectangle) {
        if (rectangle instanceof Triangle2DY triangle) {
