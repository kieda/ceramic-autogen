...
//    AWhitespaceParser WHITESPACES = new AWhitespaceParser();
...
//        BASE_PARSE_TYPES.add(WHITESPACES); // finally whitespace
//    }
...
//    }
//    @Override
//    public AProperties<? extends Object> parse(CharSequence cs) {
